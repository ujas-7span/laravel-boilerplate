...
use App\OpenApi\Extensions\ApiQueryParametersExtension;
...
return [
     ...
     *
     * In development, this is null by default so documentation updates in real-time.
     * Use `scramble:cache` to warm the cache in production and `scramble:clear` to invalidate it.
     */
    'cache' => [
        'key' => 'scramble.openapi',
        'store' => env('SCRAMBLE_CACHE_STORE', null),
    ],
    ...
    'extensions' => [
        ApiQueryParametersExtension::class,
    ],
